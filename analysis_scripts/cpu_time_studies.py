...
def draw_runtime_pie(dict_time, title, suffix =""):
    """
    ...
    cv.SaveAs("results/cpu_time_studies/pie"+suffix+".png")

def draw_step_comparison_pie(list_time, algo = "Algorithm:TrackFindingAlgorithm", suffix =""):
    """
    ...
    cv.SaveAs("results/cpu_time_studies/pieStep"+suffix+".png")
...
def main():
    ...
    dir_list = [
        "results/output_40GeV_newSeeding_standardSeeding_deadZones_maxSeedSpMPrim1_maxSeedSpMSec20_ImpMax1_dZMax50_branch1_periferal_factor_0.01",
        "results/output_40GeV_newSeeding_standardSeeding_deadZones_maxSeedSpMPrim1_maxSeedSpMSec20_ImpMax1_dZMax50_branch1_periferal_factor_0.05",
        "results/output_40GeV_newSeeding_standardSeeding_deadZones_maxSeedSpMPrim1_maxSeedSpMSec20_ImpMax1_dZMax50_branch1_periferal_factor_0.1",
        "results/output_40GeV_newSeeding_standardSeeding_deadZones_maxSeedSpMPrim1_maxSeedSpMSec20_ImpMax1_dZMax50_branch1_periferal_factor_0.2",
        "results/output_40GeV_newSeeding_standardSeeding_deadZones_maxSeedSpMPrim1_maxSeedSpMSec20_ImpMax1_dZMax50_branch1_periferal_factor_0.4",
        "results/output_40GeV_newSeeding_standardSeeding_deadZones_maxSeedSpMPrim1_maxSeedSpMSec20_ImpMax1_dZMax50_branch1_periferal_factor_0.6",
        "results/output_40GeV_newSeeding_standardSeeding_deadZones_maxSeedSpMPrim1_maxSeedSpMSec20_ImpMax1_dZMax50_branch1_periferal_factor_0.8",
        "results/output_40GeV_newSeeding_standardSeeding_deadZones_maxSeedSpMPrim1_maxSeedSpMSec20_ImpMax1_dZMax50_branch1"
        ]
    suffix_list = [
                "periferal_factor_0.01",
                "periferal_factor_0.05",
                "periferal_factor_0.1",
                "periferal_factor_0.2",
                "periferal_factor_0.4",
                "periferal_factor_0.6",
                "periferal_factor_0.8",
                "central"
                ]
    mult_list = [
                    0.01,
    ...
    for i, (dir, suffix, mult) in enumerate(zip(dir_list, suffix_list, mult_list)):
        ...
        draw_runtime_pie(dict_time, "Time/event = " + str(round(tot_time, 3)) + " s", suffix=suffix)
        draw_step_comparison_pie(list_time, suffix=suffix)
    ...
    t.Draw()
    cv.SaveAs("results/cpu_time_studies/timevsMultiplicity.png")
    cv.SetLogy()
    cv.SaveAs("results/cpu_time_studies/timevsMultiplicityLog.png")
